...
RUN git clone https://github.com/mGageTechOps/ansible-role-cfn-s3-bucket
RUN cd ansible-role-cfn-s3-bucket && git checkout 0.0.6
RUN mv ansible-role-cfn-s3-bucket roles/ansible-role-cfn-s3-bucket
